        ...
        if (perfil != null) {
            ...
            json.append("{")
                    ...
                    .append(perfil.getDireccionDetalle() != null
                            ? perfil.getDireccionDetalle().replace("\"", "\\\"").replace("\n", " ").replace("\r", "")
                            : "")
                    .append("\",")
                    .append("\"telefono\":\"")
                    ...
                    .append(perfil.getTelefonoSecundario() != null
                            ? perfil.getTelefonoSecundario().replace("\"", "\\\"").replace("\n", " ").replace("\r", "")
                            : "")
                    .append("\",")
                    .append("\"referencia_ubicacion\":\"")
                    .append(perfil.getReferencia() != null
                            ? perfil.getReferencia().replace("\"", "\\\"").replace("\n", "\\n").replace("\r", "")
                            : "")
                    .append("\",")
            ...
            response.getWriter().print("{\"nombre\":\"" + nombreSeguro + "\", \"apellido\":\"" + apellidoSeguro
                    + "\", \"correo\":\"" + correoSeguro + "\"}");
        }
    }
