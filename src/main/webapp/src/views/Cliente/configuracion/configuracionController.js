...
// importamos el controlador de login para redirigir si no hay sesion
import { cargarVistaLogin } from '../../Auth/login/loginController.js';
...
export async function cargarVistaConfiguracion() {
    ...
    try {
        ...
        if (!respuesta.ok) {
            alert('Debes iniciar sesión para acceder a tu configuración.');
            cargarVistaLogin(); // Lo mandamos a la pantalla de login
